...
export function GestionCalenadrio( { route, navigation } ) {
  ...
  console.log("day", day, idcobrador, fullDate);
  useEffect(() => {
  ...
  const handleCardPress = (item, index) => {
    navigation.navigate(screen.registro.tab, { screen: screen.registro.insertCall, params: { item } });
  };
